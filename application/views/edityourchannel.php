...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
  ...
  <section id="about" class="about-section">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1>Update Your Tutorial here ...</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-heading">Isi da`ta dengan benar </div>
            <div class="panel-body">

            <?php foreach ($data_edit as $edit ) {

             ?>
              <form class="" action="<?php echo base_url();?>index.php/welcome/UpdateVideo/<?php echo $edit->id_karya; ?>" method="post" enctype="multipart/form-data">

                <input type="text" name="judulvideo" value="<?php echo $edit->judul_video;?>">
              ...
              <table class="table">
                  <thead class="panel panel-success success">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#"><span class=" warning glyphicon glyphicon-pencil"></span></a>
                        <a href="#"><span class="warning  glyphicon glyphicon-remove"></span></a>
      ...
      <div class="row">
        ...
        <video   width="600px" height="400px"   src="<?php echo base_url();?>videos/vid2.mp4"  controls>
