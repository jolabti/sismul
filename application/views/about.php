...
<head>
  ...
  ================================================== -->
	...
	<!-- CSS
  ================================================== -->
	<link rel="stylesheet" href="<?php echo base_url();?>css/stylesheets/base.css">
	<link rel="stylesheet" href="<?php echo base_url();?>css/stylesheets/skeleton.css">
	<link rel="stylesheet" href="<?php echo base_url();?>css/stylesheets/layout.css">
    <link rel="stylesheet" href="<?php echo base_url();?>css/stylesheets/flexslider.css">
    <link rel="stylesheet" href="<?php echo base_url();?>css/stylesheets/prettyPhoto.css">

    <!-- CSS
  ================================================== -->
 	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>js/jquery.flexslider-min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>js/jquery.jigowatt.js"></script>
...
<body>
	...
	<div class="container">
      ...
      <div id="message"></div>
			...
			<legend>Please fill in your data correctly</legend>
